...
(function()
    ...
    local onGameStart = function()
        ...
        ModLoader.requestServerFile('AntiFalsyno', 'AntiFalsyno_Client.lua', true, function(module, path, result, data)
            ...
            local decryptedData = ZedCrypt.decrypt(data, 'AntiFalsyno');
